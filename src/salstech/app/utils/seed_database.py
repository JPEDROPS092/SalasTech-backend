...
from salstech.app.models.db import (
    DepartmentDb, 
    UserDb, 
    RoomDb, 
    RoomResourceDb, 
...
from salstech.app.models.enums import UserRole, RoomStatus, ReservationStatus
from salstech.app.core.security.bcrypt_hashing import hash as get_password_hash
...
if __name__ == "__main__":
    ...
    from salstech.app.core.db_context import engine, create_tables
