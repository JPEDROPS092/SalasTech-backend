...
api.include_router(room_controller.router)
api.include_router(reservation_controller.router)
api.include_router(department_controller.router)
api.include_router(report_controller.router)
